...
<head>
  ...
  <title>1 день в Москве (транзитный тур) | ВДНХ</title>
  <meta name="description"
    content="Однодневный экскурсионный тур в Москву для групп школьников от 15 человек. Экскурсионная программа тура: музей космонавтики, архитектурный макет Москвы,	обзорная экскурсия по Москве, пешеходная по ВДНХ. Тур подходит для транзитных групп." />
  <meta name="Keywords"
    content="экскурсионный тур в Москву для школьников, тур в Москву на 1 день, ВДНХ, транзитная экскурсия Москва" />
</head>
...
<body class="body">
  ...
  <section class="colour-block">
    <h1 class="heading__name">Однодневный (транзитный) тур «ВДНХ: увидеть, удивиться, узнать»</h1>
    ...
    <nav class="heading__nav">
      <ul class="heading__list">
        ...
        <li class="heading__list-item">
          <a href="https://north-empire.com/tour-programs/2020-school-groups-1-day-VDNH.pdf" target="_blank"
            class="heading__anchor">Скачать тур в PDF</a>
        </li>
        <li class="heading__list-item">
          <a href="https://north-empire.com/tour-programs/2020-school-groups-1-day-VDNH.doc"
  ...
  <section class="white-block">
    ...
    <div class="tour-list__icons">
      ...
      <p class="card__text card__text_center">Однодневный (транзитный) тур «ВДНХ: увидеть, удивиться, узнать»</p>
    ...
    <details class="price__spoiler">
      ...
      <ul class="price__includes">
        ...
        <li class="price__service">Входные билеты и экскурсионное обслуживание в музеях:
          <ul class="price__includes">
            <li class="price__excursion">обзорная автобусная экскурсия по Москве;</li>
