...
<head>
  ...
  <title>1 день в Москве (транзитный тур) | кинематограф</title>
  <meta name="description"
    content="Однодневный экскурсионный тур в Москву для групп школьников от 15 человек. Экскурсионная программа тура:	Мосфильм, канатная дорога, тур подходит для транзитных групп." />
  <meta name="Keywords"
    content="экскурсионный тур в Москву для школьников, тур в Москву на 1 день, Мосфильм, транзитная экскурсия Москва" />
</head>
...
<body class="body">
  ...
  <section class="colour-block">
    <h1 class="heading__name">Однодневный (транзитный) тур «Жизнь моя, кинематограф...»</h1>
    ...
    <nav class="heading__nav">
      <ul class="heading__list">
        ...
        <li class="heading__list-item">
          <a href="https://north-empire.com/tour-programs/2020-school-groups-1-day-cinema.pdf" target="_blank"
            class="heading__anchor">Скачать тур в PDF</a>
        </li>
        <li class="heading__list-item">
          <a href="https://north-empire.com/tour-programs/2020-school-groups-1-day-cinema.doc"
  ...
  <section class="white-block">
    ...
    <div class="tour-list__icons">
      ...
      <p class="card__text card__text_center">Однодневный (транзитный) тур «Жизнь моя, кинематограф...»</p>
    ...
    <div class="info">
      <div class="card card_half">
        <div class="card">
          ...
          <div class="card__description">
            ...
            <p class="card__text">на выбор группы, кроме понедельника и вторника</p>
      ...
      <div class="card card_half">
        <div class="card">
          ...
          <div class="card__description">
            <h4 class="card__title">Музеи и объекты посещения:</h4>
  ...
  <main class="colour-block">
    ...
    <div class="day">
      ...
      <?php include("../../blocks/excursions/funicular.php"); ?>
  ...
  <section class="white-block">
    ...
    <p class="price__service">Доплата за взрослых (родителей) в группе &ndash; 250&nbsp;рублей с 1 человека</p>
    <p class="price__service">Доплата за школьников старше 14&nbsp;лет &ndash; 250&nbsp;рублей с 1 человека</p>
    ...
    <details class="price__spoiler">
      ...
      <ul class="price__includes">
        ...
        <li class="price__service">Входные билеты и экскурсионное обслуживание в музеях, экскурсии:
          <ul class="price__includes">
            ...
            <li class="price__excursion">проезд по московской канатной дороге;</li>
          </ul>
        </li>
      </ul>
    </details>
