...
<head>
  ...
  <title>Осенние краски Москвы 3 дня | Экскурсионный тур для групп от 10 человек</title>
 ...
 <section class="colour-block">
    ...
    <nav class="heading__nav">
      <ul class="heading__list">
        ...
        <li class="heading__list-item">
          <a href="https://north-empire.com/tour-programs/2020-school-groups-3-days-constructor.pdf" target="_blank"
            class="heading__anchor">Скачать тур в PDF</a>
        </li>
        <li class="heading__list-item">
          <a href="https://north-empire.com/tour-programs/2020-school-groups-3-days-constructor.doc"
    ...
    <div class="card card_half">
      ...
      <div class="card">
        ...
        <div class="card__description">
          ...
          <p class="card__text">3 день – 8 часов</p>
        </div>
      </div>
    </div>
