...
<head>
  ...
  <title>Эконом-тур в Москву 3 дня | Экскурсионный тур для групп от 15 человек</title>
  <meta name="description"
    content="Экономичный экскурсионный тур в Москву для групп школьников от 15 человек. Экскурсионная программа тура построена с учётом особенностей школьников." />
...
<?php include("../../blocks/parts-of-pages/header.php"); ?>
 ...
 <section class="colour-block">
    <h1 class="heading__name">Эконом-тур</h1>
    <p class="heading__type">Экскурсионный тур для организованных групп школьников от 15 человек</p>
    ...
    <nav class="heading__nav">
      <ul class="heading__list">
        ...
        <li class="heading__list-item">
          <a href="https://north-empire.com/tour-programs/2020-school-groups-economy-tour-3-days.pdf" target="_blank"
            class="heading__anchor">Скачать тур в PDF</a>
        </li>
        <li class="heading__list-item">
          <a href="https://north-empire.com/tour-programs/2020-school-groups-economy-tour-3-days.doc"
  ...
  <?php include("../../blocks/icons/group.php"); ?>
    ...
    <p class="card__text card__text_center">Эконом-тур</p>
    ...
    <div class="card card_half">
      ...
      <div class="card">
        ...
        <div class="card__description">
          ...
          <p class="card__text">1 день – 4 часа</p>
  ...
  <main class="colour-block">
    ...
    <details class="day">
      <summary class="day__summary summary">1 день
        <h3 class="day__sightseeing">Обзорная экскурсия по Москве, Исторический музей</h3>
      </summary>
      ...
      <?php include("../../blocks/excursions/History.php"); ?>
    ...
    <details class="day">
      <summary class="day__summary summary">2 день
        <h3 class="day__sightseeing">Литературный музей А.&nbsp;С.&nbsp;Пушкина на&nbsp;Арбате</h3>
      </summary>
      ...
      <?php include("../../blocks/excursions/Lit_Pushkin.php"); ?>
      <?php include("../../blocks/excursions/dinner_cafe.php"); ?>
      <?php include("../../blocks/excursions/finish_center.php"); ?>
      <?php include("../../blocks/excursions/Arbat-extra-pay.php"); ?>
    </details>

    <details class="day">
      <summary class="day__summary summary">3 день
        <h3 class="day__sightseeing">усадьба Коломенское, макет Москвы</h3>
      </summary>
      <?php include("../../blocks/excursions/breakfast_hotel.php"); ?>
      <?php include("../../blocks/excursions/meet_hotel.php"); ?>
      ...
      <div class="day__container">
        ...
        <div class="card__description card__description_big">
          <p class="card__title">Переезд на автобусе на ВДНХ</p>
          <p class="card__text">Путевая информация. Окончание работы автобуса на ВДНХ.</p>
      ...
      <div class="day__container">
        ...
        <div class="card__description card__description_big">
          <h4 class="card__title card__title_extra-pay">За доплату пешеходная экскурсия по&nbsp;ВДНХ</h4>
          <p class="card__text card__text_extra-pay">Прогулка от&nbsp;арки Главного входа по&nbsp;Центральной аллее к&nbsp;павильону &#8470;&nbsp;1, осмотр знаменитых фонтанов &laquo;Дружба народов&raquo; и&nbsp;&laquo;Каменный цветок&raquo;, павильонов &laquo;Белорусская ССР&raquo;, &laquo;Земледелие&raquo;, &laquo;Космос&raquo; на&nbsp;площади Промышленности и&nbsp;ракеты-носителя &laquo;Восток&raquo;&nbsp;&mdash; копии космического корабля, на&nbsp;котором Гагарин облетел Землю.</p>
  ...
  <section class="white-block">
    ...
    <thead><tr><th>40+4</th> <th>30+3</th> <th>20+2</th> <th>15+1</th><th>10+1</th></tr></thead>
      <tbody>
        <tr>
        <td>8350</td><td>8950</td><td>10200</td><td>10500</td><td>12300</td>
        </tr>
      </tbody>
    </table>
    ...
    <thead><tr><th>40+4</th> <th>30+3</th> <th>20+2</th> <th>15+1</th><th>10+1</th></tr></thead>
      <tbody>
        <tr>
        <td>8700</td><td>9450</td><td>10650</td><td>11100</td><td>12800</td>
        </tr>
      </tbody>
    </table>
    ...
    <p class="price__service">Доплата за взрослых (родителей) в группе &ndash; 750&nbsp;рублей с&nbsp;1&nbsp;человека</p>
      ...
      <ul class="price__includes">
        ...
        <li class="price__service">Входные билеты и экскурсионное обслуживание в музеях:
          <ul class="price__includes">
            ...
            <li class="price__excursion">экскурсия в Исторический музей;</li>
            <li class="price__excursion">пешеходная экскурсия по Арбату;</li>
            <li class="price__excursion">экскурсия в литературный музей А.&nbsp;С.&nbsp;Пушкина на&nbsp;Арбате;</li>
    ...
    <details class="price__spoiler">
      ...
      <ul class="price__not-includes">
        ...
        <li class="price__service">Экскурсия по ВДНХ.</li>
