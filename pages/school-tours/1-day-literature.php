...
<head>
  ...
  <title>1 день в Москве (транзитный тур) | Литературная тема</title>
  <meta name="description"
    content="Однодневный экскурсионный тур в Москву для групп школьников от 15 человек. Экскурсионная программа тура построена с уклоном в литературную тематику: музей Пушкина, Арбат, Москва литературная. Тур подходит для транзитных групп." />
  <meta name="Keywords"
    content="экскурсионный тур в Москву для школьников, тур в Москву на 1 день, литературные экскурсии, транзитная экскурсия Москва" />
</head>
...
<body class="body">
  ...
  <section class="colour-block">
    <h1 class="heading__name">Однодневный (транзитный) тур «Литературные&nbsp;страницы&nbsp;Москвы»</h1>
    ...
    <nav class="heading__nav">
      <ul class="heading__list">
        ...
        <li class="heading__list-item">
          <a href="https://north-empire.com/tour-programs/2020-school-groups-1-day-literature.pdf" target="_blank"
            class="heading__anchor">Скачать тур в PDF</a>
        </li>
        <li class="heading__list-item">
          <a href="https://north-empire.com/tour-programs/2020-school-groups-1-day-literature.doc"
  ...
  <section class="white-block">
    ...
    <div class="tour-list__icons">
      ...
      <p class="card__text card__text_center">Однодневный (транзитный) тур «Литературные&nbsp;страницы&nbsp;Москвы»</p>
  ...
  <main class="colour-block">
    ...
    <div class="day">
      ...
      <?php include("../../blocks/excursions/city-tour_literature.php"); ?>
  ...
  <section class="white-block">
    ...
    <p class="price__service">Доплата за взрослых (родителей) в группе &ndash; 150&nbsp;рублей с 1 человека</p>
    ...
    <details class="price__spoiler">
      ...
      <ul class="price__includes">
        ...
        <li class="price__service">Входные билеты и экскурсионное обслуживание в музеях в зависимости от выбранных дней:
          <ul class="price__includes">
            <li class="price__excursion">тематическая автобусная экскурсия «Москва литературная»</li>
            <li class="price__excursion">пешеходная экскурсия по Арбату;</li>
            <li class="price__excursion">литературный музей А.&nbsp;С.&nbsp;Пушкина на&nbsp;Арбате;</li>
          </ul>
        </li>
      </ul>
    </details>
